class CheckIn < ApplicationRecord
  ...
  def set_music_content
    ...
    chaptgpt_music_response["choices"][0]["message"]["content"]
  end
  ...
  def set_video_content
    ...
    chaptgpt_video_response["choices"][0]["message"]["content"]
  end
